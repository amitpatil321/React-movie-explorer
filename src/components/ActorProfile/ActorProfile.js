...
export default class ActorProfile extends Component {
  ...
  componentDidMount() {
    if (this.props.match.params.id) {
      ...
      PeopleAPI.profile(this.props.match.params.id)
        .then((response) => {
    ...
    } // If id isnt provided then, redirect to home
    else this.props.history.push(CONFIG.ROUTES.HOME);
  }

  render() {
    // Handle error and show error message
    if (this.state.error != null) return this.state.error;
